...
const char *css_footer = "width: 100%; padding: 24px 0; display: flex; "
...
const char *msg_bio = "I am a software engineer because programming turned out "
		      "to be the best "
		      "way I know to understand things. \n"
		      "Whether I am studying programming languages, writing "
		      "software, exploring "
		      "theology, or writing poetry, I find myself asking the "
		      "same questions "
		      "about structure, meaning, and first principles. \n"
		      "This site is where those explorations converge.\n";

const char *msg_seo = "Software engineer specialized in programming languages, "
		      "compilers, formal "
		      "methods, "
		      "type systems, virtual machines, operating systems, and "
		      "systems "
		      "programming using "
		      "C, Haskell, Rust, and TypeScript. Work includes Bend, "
		      "HVM, Kind, Higher "
		      "Order "
		      "Company tooling, and Agoriz, with emphasis on dependent "
		      "types, proof "
		      "systems, "
		      "interpreters, runtime architecture, memory management, "
		      "distributed "
		      "systems, "
		      "functional computation, and minimalist kernel "
		      "development.";

const char *msg_404_title = "404 - NOT FOUND";
const char *msg_404_body = "The page you are looking for does not exist or has "
			   "been moved.";
